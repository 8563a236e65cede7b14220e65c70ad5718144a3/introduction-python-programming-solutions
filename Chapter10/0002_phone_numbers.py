...
Grace 20-24564555
Anna 194-49611659
Phone Number Contains a 3- or 2-Digit Area Code and a Hyphen
followed by an 8-digit Number
Find All Names Having Phone Numbers with a 3-Digit Area Code
...
def main():
    ...
    with open("Chapter10/person_details.txt", "r") as file_handler:
