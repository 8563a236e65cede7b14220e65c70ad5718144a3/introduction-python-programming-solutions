"""
Program 11.16
Demonstrate Base and Derived Class Relationship
...
class FootBall:
    ...
    def fifa(self):
        print(f"{self.country} national football team is placed"
              f" in '{self.division}' FIFA division")


class WorldChampions(FootBall):
    def world_championship(self):
        print(f"{self.country} national football team is "
              f"{self.no_of_times} times world champions")
