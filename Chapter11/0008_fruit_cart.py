"""
Program 11.6
Define a Class Called Cart that Contains Data Atrributes Apples
and Oranges. Write Methods that Return Appropriate Messages If
the Number of Apples is Greater than 5 or When the Number of Oranges
are Greater than 10
"""
